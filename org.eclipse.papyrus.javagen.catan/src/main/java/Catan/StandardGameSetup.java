...
public final class StandardGameSetup {
    ...
    public static Board buildFullBoard() {
        ...
        List<Path> paths = List.of(
                new Path(0, 0, 1), new Path(1, 0, 5), new Path(2, 0, 17), new Path(3, 1, 2),
                new Path(4, 1, 21), new Path(5, 2, 3), new Path(6, 2, 6), new Path(7, 3, 4),
                new Path(8, 3, 9), new Path(9, 4, 5), new Path(10, 4, 12), new Path(11, 5, 13),
                new Path(12, 6, 7), new Path(13, 6, 23), new Path(14, 7, 8), new Path(15, 7, 24),
                new Path(16, 8, 9), new Path(17, 8, 27), new Path(18, 9, 10), new Path(19, 10, 11),
                new Path(20, 10, 29), new Path(21, 11, 12), new Path(22, 11, 32), new Path(23, 12, 14),
                new Path(24, 13, 15), new Path(25, 13, 18), new Path(26, 14, 15), new Path(27, 14, 34),
                new Path(28, 15, 35), new Path(29, 16, 17), new Path(30, 16, 18), new Path(31, 16, 41),
                new Path(32, 17, 19), new Path(33, 18, 38), new Path(34, 19, 20), new Path(35, 19, 44),
                new Path(36, 20, 21), new Path(37, 20, 47), new Path(38, 21, 22), new Path(39, 22, 23),
                new Path(40, 22, 49), new Path(41, 23, 52), new Path(42, 24, 25), new Path(43, 24, 53),
                new Path(44, 25, 26), new Path(45, 26, 27), new Path(46, 27, 28), new Path(47, 28, 29),
                new Path(48, 29, 30), new Path(49, 30, 31), new Path(50, 31, 32), new Path(51, 32, 33),
                new Path(52, 33, 34), new Path(53, 34, 36), new Path(54, 35, 37), new Path(55, 35, 39),
                new Path(56, 36, 37), new Path(57, 38, 39), new Path(58, 38, 42), new Path(59, 40, 41),
                new Path(60, 40, 42), new Path(61, 41, 43), new Path(62, 43, 44), new Path(63, 44, 45),
                new Path(64, 45, 46), new Path(65, 46, 47), new Path(66, 47, 48), new Path(67, 48, 49),
                new Path(68, 49, 50), new Path(69, 50, 51), new Path(70, 51, 52), new Path(71, 52, 53)
        );
